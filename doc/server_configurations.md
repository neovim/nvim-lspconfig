...
solidity-ls is a LSP for solidity ported from CoC.  It has diagnostics, autocomplete, go to definition, etc.

It requires the solc binary installed in your system, with the same version of your files.
