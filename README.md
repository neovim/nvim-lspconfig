...
Download binary from https://github.com/dalance/svls/releases

This server accepts configuration into .svls.toml at the root of repository.

Example of configuration to drop at the repository top level:
