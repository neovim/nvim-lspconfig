...
local function get_java_executable()
  local executable = env.JAVA_HOME and env.JAVA_HOME .. '/bin/java' or 'java'

  return sysname:match 'Windows' and executable .. '.exe' or executable
end

local function get_workspace_dir()
  return env.WORKSPACE and env.WORKSPACE or env.HOME .. '/workspace'
end
...
local function get_jdtls_config()
  if sysname:match 'Linux' then
    return env.JDTLS_HOME .. '/config_linux'
  elseif sysname:match 'Darwin' then
    return env.JDTLS_HOME .. '/config_mac'
  elseif sysname:match 'Windows' then
    return env.JDTLS_HOME .. '/config_win'
  else
    return env.JDTLS_HOME .. '/config_linux'
  end
end
